      ...
      >
        ...
        <form className="w-full min-[640px]:pt-4" onSubmit={handleSubmit}>
          <div className="flex p-[2px] overflow-hidden justify-center items-center bg-[#53a8ca] rounded-3xl h-10">
            ...
            <input className="w-full h-full rounded-full text-xl grid text-white placeholder-white bg-[#03cdff] px-2 outline-none" type="text" placeholder="search" id="cityName" />
          </div>
